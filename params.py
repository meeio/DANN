...
def get_params():
    ...
    parser.add_argument("--steps", type=int, default=2500, help="Epochs of train data")

    parser.add_argument("--log_per_step", type=int, default=40, help="Epochs of train data")
